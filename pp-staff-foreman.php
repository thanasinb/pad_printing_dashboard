        ...
        <main>
            ...
            <div class="container-fluid px-4 mt-n10">
                <div class="card mb-4 w-100" id="table-machine">
                    <div class="card-header bg-red fw-bold text-white fs-4">Foremans List</div>
                    <div class="card-body">
                        <table id="datatablesSimple" class="table table-striped">
                            <thead class="text-black" style="background-color: #ffea07"><?php require 'pp-staff-table-head.php' ?></thead>
                            <tbody><?php require "pp-staff-list-staff-script-foreman.php"; ?></tbody>
                        </table>
                    </div>
                </div>
            </div>

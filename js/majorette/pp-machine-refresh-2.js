        ...
        if (item_no!=''){
            ...
            $.ajax({
                ...
                success: function(dataResult){
                    ...
                    qty_accum = qty_complete + Math.floor(qty_process*divider) - qty_repeat;
                    ...
                    if (qty_order - qty_accum <= 500){
                        ...
                        // $(this).parent().find('.progress-bar').addClass('bg-orange');
                    }else {
                        $(this).parent().find('.progress-bar').removeClass('blink_me bg-orange');
                        // $(this).parent().find('.progress-bar').removeClass('bg-orange');
                    }
                    ...
                    // $(this).parent().find('.est_date').text("run_time_open: " + run_time_open + "\n" + "est_time: " + est_time.toLocaleTimeString('es-CL') + "\n");
                    ...
                    // $(this).parent().find('.est_time').text(est_time.toLocaleTimeString('es-CL'));
                    // $(this).parent().find('.est_time').text("run_time_open: " + run_time_open + "\n" + "run_time_open_temp: " + run_time_open_temp + "\n" + "second_of_this_day: " + seconds_of_this_day + "\n" + "second_to_complete: " + seconds_to_complete + "\n");

...
//$sql = "DELETE FROM activity WHERE id_machine = '" . $_GET['id_mc'] . "' AND status_work<3";
...
//$sql = "DELETE FROM activity_downtime WHERE id_machine = '" . $_GET['id_mc'] . "' AND status_downtime<3";
...
$sql = "DELETE FROM activity_rework WHERE id_machine = '" . $_GET['id_mc'] . "' AND status_work<3";
